...
graph TB
    ...
    subgraph Protocol["CoW Protocol"]
        ...
        SWAP --> SWAP_TUT[Trading Tutorials]
        SWAP --> SWAP_WID[Widget]
        SWAP --> SWAP_HOOK[Hook dApps]

        EXPL --> EXPL_TUT[Explorer Tutorials]

        INT --> INT_API[API Integration]
        INT --> INT_QS[Quickstarts]
        INT --> INT_TEST[Testing]
