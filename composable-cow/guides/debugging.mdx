---
title: "Debugging Conditional Orders"
description: "Decision tree for diagnosing why a conditional order didn't execute — from watch-tower indexing to solver settlement."
---

# Debugging Conditional Orders

Use this decision tree when your conditional order isn't executing as expected.
...
- Has the conditional order been cancelled on-chain?
