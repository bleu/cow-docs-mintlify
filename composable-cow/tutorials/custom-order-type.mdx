...
description: "Tutorial for implementing, deploying, and registering a custom programmatic order with ComposableCoW"
---
...
If the order doesn't appear, see [Debugging Programmatic Orders](/composable-cow/guides/debugging) for troubleshooting.
...
- [Debugging Programmatic Orders](/composable-cow/guides/debugging) — when orders don't execute
