...
## AMMs don't want you to know about LVR[​](#amms-dont-want-you-to-know-about-lvr "Direct link to AMMs don't want you to know about LVR")
...
## An AMM designed with LPs in mind[​](#an-amm-designed-with-lps-in-mind "Direct link to An AMM designed with LPs in mind")
...
## Deploy liquidity on CoW AMM[​](#deploy-liquidity-on-cow-amm "Direct link to Deploy liquidity on CoW AMM")
