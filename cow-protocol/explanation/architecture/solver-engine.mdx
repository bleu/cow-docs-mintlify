---
title: "Solver Engine"
description: "The solver engine implements CoW Protocol batch auction solving — receiving auction instances and returning optimal order execution solutions."
---
