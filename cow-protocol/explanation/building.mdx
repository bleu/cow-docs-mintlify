...
<CardGroup cols={3}>
  ...
  <Card title="SDK" icon="code" href="/cow-sdk/quickstart">
    Full TypeScript SDK for custom apps
  </Card>
  <Card title="API" icon="square-terminal" href="/cow-protocol/howto/integrate/api">
...
|---|---|
| **[CoW SDK](/cow-sdk/quickstart)** | TypeScript SDK — order creation, signing, management |
...
| **[ComposableCoW](/composable-cow/introduction)** | Conditional orders framework |
