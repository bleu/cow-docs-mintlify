...
description: "A flash loan typically happens in the following steps:"
---
...
## Flash loans Use Cases[​](#flash-loans-use-cases "Direct link to Flash loans Use Cases")

A flash loan can be useful in many different scenarios. For example:

* **[Paying outstanding debt with collateral](/cow-protocol/explanation/order-types/pay-debt-flash-loans)**: A key use case of flash loans is the ability to repay debt with collateral, since flash loans allow users to close or reduce their debt positions without needing upfront liquidity.
