...
sidebarTitle: "Specify a flash loan"
description: "How integrators encode a flash loan hint into a CoW Protocol order's app data so solvers can use it during settlement."
---
