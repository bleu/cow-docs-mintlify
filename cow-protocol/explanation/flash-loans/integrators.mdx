...
sidebarTitle: "Specifying flash loan orders"
description: "How to encode flash loan hints into CoW Protocol order metadata so solvers can optimize execution."
---
