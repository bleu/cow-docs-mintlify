...
description: "CoW Protocol offers multiple integration approaches to suit different development needs and use cases. Whether you're building a DeFi application, creating a custom trading interface, or integrating CoW's functionality into your existing platform, there's an integration method that fits your requirements."
---

## Integration Approaches[​](#integration-approaches "Direct link to Integration Approaches")
...
## Choose Your Integration Method[​](#choose-your-integration-method "Direct link to Choose Your Integration Method")

### 🎨 Widget Integration[​](#-widget-integration "Direct link to 🎨 Widget Integration")
...
### 🛠️ SDK Integration[​](#️-sdk-integration "Direct link to 🛠️ SDK Integration")
