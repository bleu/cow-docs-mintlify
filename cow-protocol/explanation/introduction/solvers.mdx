---
title: "Solvers"
description: "CoW Protocol delivers optimal price outcomes by leveraging an open solver competition for order matching."
---

![Solvers](/images/cow-protocol/explanation/introduction/assets/images/solvers-8a4a55139d429eae38cb767c451bdc32.png)

Solvers are bonded third parties that execute trades on behalf of users through an [intent-based delegated execution model](/cow-protocol/explanation/introduction/intents).

Once a user submits an [intent](/cow-protocol/explanation/introduction/intents), the protocol groups it alongside other intents in a batch auction. As soon as a batch is "closed for orders", meaning that it stops considering new orders, the protocol runs a [competition](/cow-protocol/reference/core/auctions) where solvers submit solutions for the intents in the batch.
...
## How Solvers Work[​](#how-solvers-work "Direct link to How Solvers Work")
