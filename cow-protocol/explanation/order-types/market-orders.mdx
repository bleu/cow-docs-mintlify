---
title: "Market orders"
description: "Market orders are orders to buy or sell tokens as soon as possible at the current market rate."
---
...
<Note>
  Unlike other DEXs, your slippage tolerance cannot be extracted by MEV Bots (cf. [MEV Protection](/cow-protocol/explanation/benefits/mev-protection)). If the solvers are able to find optimizations within the batch auction your order is settled with, you may also get a better price.
</Note>

## Getting started[​](#getting-started "Direct link to Getting started")

Wanting to make a market order? Check out our [market order tutorial](/cow-swap/tutorials/swap).
