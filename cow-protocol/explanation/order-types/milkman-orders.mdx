...
description: "Overview of Milkman orders on CoW Protocol — a price-feed-based order placement mechanism popular with DAOs and treasury trades."
---
...
![Milkman Order Flow](/images/cow-protocol/concepts/order-types/assets/images/milkman-order-flow-bf340ed0793082a1c58b5f581c970ade.png)
...
```
function requestSwapExactTokensForTokens(	uint256 amountIn,	IERC20 fromToken,	IERC20 toToken,	address to,	address priceChecker,	bytes calldata priceCheckerData)
```
