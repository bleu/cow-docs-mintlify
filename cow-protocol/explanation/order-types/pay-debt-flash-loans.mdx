...
sidebarTitle: "Debt repayment"
description: "Use CoW Protocol flash loans to repay debt with collateral — close or reduce debt positions without upfront liquidity."
---
