...
sidebarTitle: "Repay debt with flash loans"
description: "How CoW Protocol flash loans let users close or reduce debt positions using their collateral, without upfront liquidity."
---
