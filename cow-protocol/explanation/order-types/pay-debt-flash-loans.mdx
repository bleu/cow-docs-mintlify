...
### How to pay back a debt with collateral[​](#how-to-pay-back-a-debt-with-collateral "Direct link to How to pay back a debt with collateral")
...
#### Lender allows a third-party to initiate the transfer of collateral tokens[​](#lender-allows-a-third-party-to-initiate-the-transfer-of-collateral-tokens "Direct link to Lender allows a third-party to initiate the transfer of collateral tokens")
...
#### Lender does not allow a third-party to initiate the transfer of collateral tokens[​](#lender-does-not-allow-a-third-party-to-initiate-the-transfer-of-collateral-tokens "Direct link to Lender does not allow a third-party to initiate the transfer of collateral tokens")
