...
description: "CoW Protocol programmatic orders — smart contract wallets using ERC-1271 to place orders with conditions that trigger automatically."
---
...
CoW Protocol's Programmatic Order Framework makes it easy to create programmatic orders that execute when certain on-chain conditions are met (such as asset prices, wallet balances, time elapsed, and much more).
