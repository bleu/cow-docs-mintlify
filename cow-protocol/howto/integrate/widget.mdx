...
description: "The CoW Widget is the fastest way to integrate CoW Protocol's trading functionality into your application. It provides a complete, pre-built trading interface that can be embedded with just a few lines of code."
---
...
## Example with Custom Theme[​](#example-with-custom-theme "Direct link to Example with Custom Theme")
...
## When to Use the Widget[​](#when-to-use-the-widget "Direct link to When to Use the Widget")
...
## Widget Configurator[​](#widget-configurator "Direct link to Widget Configurator")
...
For detailed configuration options, event handling, and advanced customization, see the [Widget Tutorial](/cow-protocol/reference/widget-params).

## Resources[​](#resources "Direct link to Resources")

* **[Widget Configurator](https://widget.cow.fi)** - Interactive configuration tool
* **[Complete Widget Guide](/cow-protocol/reference/widget-params)** - Detailed documentation
