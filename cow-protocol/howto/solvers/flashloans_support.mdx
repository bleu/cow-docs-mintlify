...
## Where to get information about an order’s flashloan?[​](#where-to-get-information-about-an-orders-flashloan "Direct link to Where to get information about an order’s flashloan?")
...
## Adjustments needed in the solver/driver[​](#adjustments-needed-in-the-solverdriver "Direct link to Adjustments needed in the solver/driver")

### Encoding the Call to the Flashloan Router[​](#encoding-the-call-to-the-flashloan-router "Direct link to Encoding the Call to the Flashloan Router")
...
### Estimating the Gas Costs[​](#estimating-the-gas-costs "Direct link to Estimating the Gas Costs")
...
### Adjusting the Order Filtering Logic[​](#adjusting-the-order-filtering-logic "Direct link to Adjusting the Order Filtering Logic")
...
### Handling Bigger Auction Instances[​](#handling-bigger-auction-instances "Direct link to Handling Bigger Auction Instances")
...
## Details on Aave’s Integration[​](#details-on-aaves-integration "Direct link to Details on Aave’s Integration")
