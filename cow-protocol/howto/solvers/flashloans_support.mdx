...
sidebarTitle: "Execute flashloan orders"
description: "How CoW Protocol solvers execute orders that include flash-loan hints, from decoding the app data to settling the trade."
---
