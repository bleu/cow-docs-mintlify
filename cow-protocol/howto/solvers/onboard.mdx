...
sidebarTitle: "Onboard as a solver"
description: "Step-by-step guide to joining the CoW Protocol solver competition — from local development to production deployment."
---
