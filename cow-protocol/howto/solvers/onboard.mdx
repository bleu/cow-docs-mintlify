...
sidebarTitle: "Joining the competition"
description: "Step-by-step guide to onboarding as a CoW Protocol solver, from local development through shadow and staging competitions to production."
---
