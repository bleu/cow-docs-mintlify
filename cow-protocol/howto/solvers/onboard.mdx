...
sidebarTitle: "Onboard a solver"
description: "Step-by-step guide for onboarding a new solver to the CoW Protocol solver competition, from local development to production."
---
