...
sidebarTitle: "Joining the solver competition"
description: "How to onboard as a solver to the CoW Protocol competition, including bonding pools, whitelisting, and shadow competition setup."
---
