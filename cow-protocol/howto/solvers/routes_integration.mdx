...
sidebarTitle: "Route integration"
description: "How DeFi teams can integrate new liquidity routes into CoW Protocol, including price discovery and settlement interface requirements."
---
