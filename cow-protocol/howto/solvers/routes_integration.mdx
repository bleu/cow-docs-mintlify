...
sidebarTitle: "Integrate new routes"
description: "Guide for DeFi teams to get new liquidity routes integrated into CoW Protocol so solvers can access more trading opportunities."
---
