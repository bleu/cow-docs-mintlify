...
### `GPv2Order.Data` struct[​](#gpv2orderdata-struct "Direct link to gpv2orderdata-struct")

The `GPV2Order.Data` is the one of the most important data structures in the Protocol. It:

* defines the parameters of an order
* is the basis of which the order digest is determined using `EIP-712` and subsequently [signed](/cow-protocol/reference/core/signing-schemes) by the user
...
<Accordion title="Balance locations">
...
### `orderUid`[​](#orderuid "Direct link to orderuid")
...
### `filledAmounts`[​](#filledamounts "Direct link to filledamounts")
...
#### `setPreSignature`[​](#setpresignature "Direct link to setpresignature")
...
### For solvers[​](#for-solvers "Direct link to For solvers")
