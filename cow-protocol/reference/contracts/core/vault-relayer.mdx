...
description: "Reference for the CoW Protocol GPv2VaultRelayer contract that holds user token allowances and protects funds from malicious solver interactions."
---
