---
title: "Flash Loans"
description: "Flash loans are handled through contracts implementing the following two interfaces:  and ."
---

## `IFlashLoanRouter` contract[​](#iflashloanrouter-contract "Direct link to iflashloanrouter-contract")
...
```
interface IFlashLoanRouter {    function flashLoanAndSettle(Loan.Data[] calldata loans, bytes calldata settlement) external;    function borrowerCallBack(bytes calldata encodedLoansWithSettlement) external;    function settlementContract() external returns (ICowSettlement);    function settlementAuthentication() external returns (ICowAuthentication);}
```

### Functions[​](#functions "Direct link to Functions")

#### `flashLoanAndSettle`[​](#flashloanandsettle "Direct link to flashloanandsettle")
...
#### `borrowerCallBack`[​](#borrowercallback "Direct link to borrowercallback")
...
#### `settlementContract`[​](#settlementcontract "Direct link to settlementcontract")
...
#### `settlementAuthentication`[​](#settlementauthentication "Direct link to settlementauthentication")
...
## `IBorrower` contract[​](#iborrower-contract "Direct link to iborrower-contract")
...
### Data Types and Storage[​](#data-types-and-storage-1 "Direct link to Data Types and Storage")
...
#### `flashLoanAndCallBack`[​](#flashloanandcallback "Direct link to flashloanandcallback")
...
#### `settlementContract`[​](#settlementcontract-1 "Direct link to settlementcontract-1")
