...
### Relying on the trampoline contract address[​](#relying-on-the-trampoline-contract-address "Direct link to Relying on the trampoline contract address")
...
### For settlement[​](#for-settlement "Direct link to For settlement")
