---
title: "Setting up a bonding pool"
description: "How to set up a CoW Protocol solver bonding pool on Mainnet, including Safe deployment, funding requirements, and approval steps."
---
