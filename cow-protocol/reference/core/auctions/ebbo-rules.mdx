...
## Certificate of EBBO violation[​](#certificate-of-ebbo-violation "Direct link to Certificate of EBBO violation")
...
## Reimbursement procedures[​](#reimbursement-procedures "Direct link to Reimbursement procedures")
...
## Escalation mechanism: Slashing of solver bond[​](#escalation-mechanism-slashing-of-solver-bond "Direct link to Escalation mechanism: Slashing of solver bond")
