...
<Accordion title="400 — DuplicatedOrder">

| Field | Value |
|---|---|
| **HTTP Status** | `400 Bad Request` |
| **Error Code** | `DuplicatedOrder` |
...
<Note>
If you are using an official SDK, prefer the SDK's built-in rate limiting and retry handling instead of reimplementing it here. See [Rate Limits & Quotas](/cow-protocol/reference/core/rate-limits) for the SDK-specific guidance, and [OrderBookApi](/cow-sdk/api/order-book-api) for the TypeScript SDK configuration surface.
</Note>
