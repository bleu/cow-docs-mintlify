...
description: "There are times when attaching additional information to an order is useful. For example:"
---
...
## AppData Document[​](#appdata-document "Direct link to AppData Document")
