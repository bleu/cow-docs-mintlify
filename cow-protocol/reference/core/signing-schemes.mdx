...
## Order digest[​](#order-digest "Direct link to Order digest")
...
```
{  name: "Gnosis Protocol",  version: "v2",  chainId: /* chain ID for the current network: e.g. 1 for mainnet */,  verifyingContract: "0x9008D19f58AAbD9eD0D60971565AA8510560ab41"}
```
...
<Check>
  ...
  [Arbitrum One](https://arbiscan.io/address/0x9008D19f58AAbD9eD0D60971565AA8510560ab41/#readContract#F2)[Avalanche](https://snowscan.xyz/address/0x9008D19f58AAbD9eD0D60971565AA8510560ab41/#readContract#F2)[Base](https://basescan.org/address/0x9008D19f58AAbD9eD0D60971565AA8510560ab41/#readContract#F2)[BNB](https://bscscan.com/address/0x9008D19f58AAbD9eD0D60971565AA8510560ab41/#readContract#F2)[Ethereum](https://etherscan.io/address/0x9008D19f58AAbD9eD0D60971565AA8510560ab41/#readContract#F2)[Gnosis](https://gnosisscan.io/address/0x9008D19f58AAbD9eD0D60971565AA8510560ab41/#readContract#F2)[Ink](https://explorer.inkonchain.com/address/0x9008D19f58AAbD9eD0D60971565AA8510560ab41/#readContract#F2)[Lens](https://explorer.lens.xyz/address/0x9008D19f58AAbD9eD0D60971565AA8510560ab41/#readContract#F2)[Linea](https://lineascan.build/address/0x9008D19f58AAbD9eD0D60971565AA8510560ab41/#readContract#F2)[Plasma](https://plasmascan.to/address/0x9008D19f58AAbD9eD0D60971565AA8510560ab41/#readContract#F2)[Polygon](https://polygonscan.com/address/0x9008D19f58AAbD9eD0D60971565AA8510560ab41/#readContract#F2)[Sepolia](https://sepolia.etherscan.io/address/0x9008D19f58AAbD9eD0D60971565AA8510560ab41/#readContract#F2)
</Check>
...
<Accordion title="hashStruct pseudocode">
  ```
...
### JavaScript example[​](#javascript-example "Direct link to JavaScript example")
...
### Etherscan Example[​](#etherscan-example "Direct link to Etherscan Example")
...
## Supported schemes[​](#supported-schemes "Direct link to Supported schemes")
...
Except for the `PreSign` scheme, all signing schemes involve signing an *order digest* that is based on the message structure of `EIP-712`.

<Check>
  In the expanded detail sections below, `signature` refers to the value passed to `signature` in the [Order book API](/cow-protocol/reference/apis/orderbook).
</Check>
...
### `ERC-1271`[​](#erc-1271 "Direct link to erc-1271")
