...
description: "Reference for CoW Protocol signing schemes — how EOAs and smart contracts authenticate off-chain orders submitted to the orderbook."
---
