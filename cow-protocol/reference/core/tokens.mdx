...
### Price estimators[​](#price-estimators "Direct link to Price estimators")
...
### Bad token list[​](#bad-token-list "Direct link to Bad token list")
...
## New `ERC-20` tokens[​](#new-erc-20-tokens "Direct link to new-erc-20-tokens")
