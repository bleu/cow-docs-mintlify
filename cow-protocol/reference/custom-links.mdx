---
title: "Custom Links"
description: "CoW Swap supports URL query parameters to allow anyone to create a custom link for sharing a specific trade with a friend or on social media, or for creating a custom link to a specific trade for your own use."
---
...
### URL links format[​](#url-links-format "Direct link to URL links format")
...
### Global parameters[​](#global-parameters "Direct link to Global parameters")

| **Parameter** | **Type** | **Default**             | **Description**                       |
| ------------- | -------- | ----------------------- | ------------------------------------- |
| `theme`       | String   | (determined by browser) | Sets theme to `dark` or `light` mode. |

### Swap / limit parameters[​](#swap--limit-parameters "Direct link to Swap / limit parameters")
