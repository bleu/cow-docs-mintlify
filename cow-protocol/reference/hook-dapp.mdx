...
### [Hook Store](/cow-protocol/reference/hook-store) — Browse and use pre-built hooks[​](#hook-store "Direct link to hook-store")

### [Hooks: Getting Started](/cow-protocol/tutorials/hooks-getting-started) — Create your first hook step-by-step[​](#hooks-getting-started "Direct link to hooks-getting-started")
...
* [Account Abstraction Guide](/cow-sdk/advanced/account-abstraction) — How to use CoW Shed for pre-authorized hook calls
* [CoW Shed SDK Reference](/cow-sdk/api/cow-shed-sdk) — Complete API reference (`@cowprotocol/sdk-cow-shed`)
* [CoW Shed Source Code](https://github.com/cowdao-grants/cow-shed) — Smart contract source
* [Hooks SDK Guide](/cow-sdk/advanced/hooks) — Using hooks with the Trading SDK, including CoW Shed integration examples
