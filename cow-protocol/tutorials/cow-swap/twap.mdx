---
title: "TWAP orders"
description: "Time-Weighted Average Price (TWAP) orders are an advanced feature of CoW Protocol, ideal for executing large trades with minimal price impact by distributing the order over a specified time."
---
...
## Placing a TWAP Order[​](#placing-a-twap-order "Direct link to Placing a TWAP Order")

### Connect your Safe wallet[​](#connect-your-safe-wallet "Direct link to Connect your Safe wallet")
...
### Specify parameters[​](#specify-parameters "Direct link to Specify parameters")
...
### Unsupported wallet? Upgrade Safe Fallback Handler[​](#unsupported-wallet-upgrade-safe-fallback-handler "Direct link to Unsupported wallet? Upgrade Safe Fallback Handler")
...
### Review and confirm[​](#review-and-confirm "Direct link to Review and confirm")
...
### Finalization and monitoring[​](#finalization-and-monitoring "Direct link to Finalization and monitoring")
...
## Cancelling a TWAP order[​](#cancelling-a-twap-order "Direct link to Cancelling a TWAP order")
