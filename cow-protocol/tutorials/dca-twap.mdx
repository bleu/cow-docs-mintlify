...
<Note>
  TWAP orders are conditional orders created via the [ComposableCoW framework](/composable-cow/introduction). They require a Safe wallet and the [Watch Tower](/watch-tower/introduction) to monitor and submit each part.
</Note>
...
For a detailed walkthrough of TWAP in the UI, see the [TWAP tutorial](/cow-protocol/tutorials/cow-swap/twap).
...
// The SDK creates a conditional order that the Watch Tower monitors.
...
- [TWAP tutorial (UI)](/cow-protocol/tutorials/cow-swap/twap) — step-by-step CoW Swap walkthrough
- [ComposableCoW Troubleshooting](/composable-cow/guides/troubleshooting) — setup issues and debugging
- [Debugging Conditional Orders](/composable-cow/guides/debugging) — when parts don't execute
