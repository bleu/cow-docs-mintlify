...
<Warning>
You must approve the **GPv2VaultRelayer** (`0xC92E8bdf79f0507f65a392b0ab4667716BFE0110`) to spend your sell token **before** submitting an order. Without this approval the order will revert on settlement.
...
- **[CoW SDK Quickstart](/cow-sdk/quickstart)** -- a more ergonomic experience with TypeScript helpers for signing, quoting, and order management
...
- **[Limit Orders](/cow-protocol/tutorials/cow-swap/limit)** -- place limit orders through CoW Swap
- **[TWAP Orders](/cow-protocol/tutorials/cow-swap/twap)** -- time-weighted average price orders
- **[API Integration Guide](/cow-protocol/howto/integrate/api)** -- complete API integration reference
