...
description: "Set up a local CoW Protocol environment to test your solver against real orderflow before joining the competition."
---
...
| [https://barn.api.cow.fi/lens/api](https://barn.api.cow.fi/lens/api)                  | Lens         | Staging     |
| [https://api.cow.fi/lens/api](https://api.cow.fi/lens/api)                            | Lens         | Production  |
