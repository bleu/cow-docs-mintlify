...
sidebarTitle: "Local solver testing"
description: "How to test a CoW Protocol solver locally against the full orderflow, including running the supporting services and connecting to a test network."
---
