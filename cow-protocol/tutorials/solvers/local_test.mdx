...
sidebarTitle: "Test a solver locally"
description: "How to spin up the CoW Protocol services locally and test a solver against the full orderflow before joining the competition."
---
