...
The CoW SDK automatically detects whether a token supports EIP-2612 and uses permit when available:
...
- **[CoW SDK Quickstart](/cow-sdk/guides/token-approvals)** -- Detailed SDK reference for approval methods
