...
description: "Reference for the SubgraphClient in the CoW Protocol Python SDK — query historical orders, settlements, and protocol metrics from the CoW subgraph."
---
