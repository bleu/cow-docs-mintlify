...
|---------|---------|---------|
| **web3** | >=6.0.0, <8.0.0 | Ethereum and blockchain interactions |
| **httpx** | >=0.23.0, <1.0.0 | Async HTTP client for API calls |
| **pydantic** | >=2.7.0 | Type-safe data models and validation |
| **eth-abi** | >=5.1.0 | Ethereum ABI encoding/decoding |
| **eth-typing** | >=4.0.0, <6.0.0 | Type hints for Ethereum |
| **backoff** | >=2.2.1 | Retry logic for API calls |
| **aiolimiter** | >=1.1.0 | Rate limiting for async operations |
