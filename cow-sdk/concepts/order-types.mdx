...
| `appData` | string | Yes | 32-byte hash of order metadata. See [App Data](/concepts/app-data) |
...
<CardGroup cols={3}>
  <Card title="Signing Schemes" href="/concepts/signing-schemes">
    Learn how orders are signed
  </Card>
  <Card title="App Data" href="/concepts/app-data">
    Add metadata to your orders
  </Card>
  <Card title="Trading SDK" href="/api/trading-sdk">
