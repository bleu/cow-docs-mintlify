---
title: "Order Types"
description: "Understanding order kinds, execution modes, and classifications in CoW Protocol"
---
...
| `appData` | string | Yes | 32-byte hash of order metadata. See [App Data](/cow-sdk/concepts/app-data) |
...
<CardGroup cols={3}>
  <Card title="Signing Schemes" href="/cow-sdk/concepts/signing-schemes">
    Learn how orders are signed
  </Card>
  <Card title="App Data" href="/cow-sdk/concepts/app-data">
    Add metadata to your orders
  </Card>
  <Card title="Trading SDK" href="/cow-sdk/api/trading-sdk">
