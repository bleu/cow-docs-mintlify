...
- Learn about [Creating Swap Orders](/guides/creating-swap-orders) for regular ERC-20 trades
- See [Order Management](/guides/order-management) to track and cancel orders
- Explore [Token Approvals](/guides/token-approvals) for ERC-20 approval management
