...
description: "How to retrieve order information and cancel orders through the CoW Protocol SDK"
---
...
- Learn about [Creating Swap Orders](/cow-sdk/guides/creating-swap-orders) to create orders
- See [Creating Limit Orders](/cow-sdk/guides/creating-limit-orders) for price-specific orders
- Explore [Token Approvals](/cow-sdk/guides/token-approvals) for managing approvals
