...
description: "Using the PRESIGN signing scheme with smart contract wallets like Safe"
---
...
**Solution**: Approve tokens before creating orders (see [Token Approvals](/guides/token-approvals) guide).
