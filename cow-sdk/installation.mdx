...
Node.js 18+ is mandatory. TypeScript support includes built-in type definitions with standard `tsconfig.json` settings (moduleResolution: "node", esModuleInterop: true).
...
The current SDK version is **v8**, with migration guidance available for v6 upgrades.
