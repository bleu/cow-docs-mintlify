---
title: "v6 to v7 Migration"
description: "Migration guide from CoW SDK v6 to v7 with the new adapter system"
---
...
- Review the [Trading SDK](/cow-sdk/api/trading-sdk) documentation for updated examples
