...
<Note>
  CoW Swap also supports [native cross-chain swaps](/cow-swap/tutorials/swap-and-bridge) through the UI, which handles bridging automatically without custom hooks.
</Note>
...
- [Hooks: Getting Started](/cow-swap/hooks/getting-started) — create your first hook step-by-step
- [Hook Store](/cow-swap/hooks/hook-store) — browse pre-built hooks or publish your own
...
- [Hook dApp Development](/cow-swap/hooks/hook-dapp) — build hooks for the CoW Swap UI
