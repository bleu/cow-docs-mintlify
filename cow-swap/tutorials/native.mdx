---
title: "Native tokens"
description: "In blockchain networks the \"native token\" - for example, Ether (ETH) on Ethereum, Arbitrum One and Base, and xDAI (xDAI) on Gnosis Chain - is the primary digital currency. It's essential for network operations, like paying transaction fees."
---
...
## Option 1) Wrap native tokens before swapping[​](#wrap-native-tokens "Direct link to Option 1) Wrap native tokens before swapping")
...
## Option 2) Use Eth-flow[​](#use-eth-flow "Direct link to Option 2) Use Eth-flow")
...
### Cancel eth-flow order[​](#cancel-eth-flow-order "Direct link to Cancel eth-flow order")
