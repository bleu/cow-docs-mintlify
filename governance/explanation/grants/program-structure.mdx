...
description: "The CoW Grants Program operates under a structured governance framework as defined in ."
---

## Committee Composition[​](#committee-composition "Direct link to Committee Composition")
...
* **2 Core Team Members**:
  ...
  * [@Master\_CoW](https://forum.cow.fi/u/Master_CoW)

The committee operates as a Gnosis Safe with a 4/5 quorum required for approving grants.

## Committee Roles[​](#committee-roles "Direct link to Committee Roles")

Each committee member may serve in one or more of these roles:

### Technical Lead[​](#technical-lead "Direct link to Technical Lead")
...
### Grant Steward[​](#grant-steward "Direct link to Grant Steward")
...
### Grant Moderator[​](#grant-moderator "Direct link to Grant Moderator")
...
## Safe Structure[​](#safe-structure "Direct link to Safe Structure")
...
## Grant Lifecycle Management[​](#grant-lifecycle-management "Direct link to Grant Lifecycle Management")
...
## Communication and Resources[​](#communication-and-resources "Direct link to Communication and Resources")
