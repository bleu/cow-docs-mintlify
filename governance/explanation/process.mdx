...
## CoW DAO Improvement Proposals (CIPs)[​](#cow-dao-improvement-proposals-cips "Direct link to CoW DAO Improvement Proposals (CIPs)")
...
<Check>
  Want to get started writing a CIP? Check out the [CIP template](/governance/reference/cip-template) to get started.
</Check>
...
### Phase 1: Community Discussion[​](#phase-1-community-discussion "Direct link to Phase 1: Community Discussion")
...
* Create a new topic in the [Governance category](https://forum.cow.fi/c/cow-improvement-proposals-cip/6/none), using the [proposal template pinned](https://forum.cow.fi/t/cip-0-template/28) to the top of the *Governance Resources* category.
...
### Phase 2: Voting[​](#phase-2-voting "Direct link to Phase 2: Voting")
...
## Process Improvement[​](#process-improvement "Direct link to Process Improvement")
