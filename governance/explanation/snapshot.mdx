...
description: "CoW DAO uses  for voting on . Votes on snapshot are weighted by the number of vCOW+COW held, or delegated to the addressed, as determined by the ."
---
...
### ENS name controller[​](#ens-name-controller "Direct link to ENS name controller")
...
#### Regular admins[​](#regular-admins "Direct link to Regular admins")
...
#### Moderators[​](#moderators "Direct link to Moderators")
