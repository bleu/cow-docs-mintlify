...
## Current Fees[​](#current-fees "Direct link to Current Fees")

### Surplus fee on out-of-market limit orders[​](#surplus-fee-on-out-of-market-limit-orders "Direct link to Surplus fee on out-of-market limit orders")
...
### Quote improvement fee on market orders[​](#quote-improvement-fee-on-market-orders "Direct link to Quote improvement fee on market orders")
...
### Volume Fee[​](#volume-fee "Direct link to Volume Fee")
...
### Partner fees[​](#partner-fees "Direct link to Partner fees")

Partners may charge a fee when integrating CoW Protocol. See the [Partner Fee](/governance/reference/partner-fee) section of these docs for details on how the partner fee is calculated, with examples and payment details.
