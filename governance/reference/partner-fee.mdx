...
<Note>
  You may charge users a fee of no more than 100 bps of order volume through your Widget or API integration. The Partner Fee has been accruing since April 4th, 2024 (the release date of the Partner Fee feature). The Partner Fee is currently only applicable to [Market order](/cow-protocol/explanation/order-types/market-orders) trades executed by your users through the Widget or API integration.
</Note>
