  ...
  <div className="mt-8">
    <Steps>
      ...
      <Step title="Pick your integration path">
        ...
        Go deeper with the [Integration overview](/cow-protocol/explanation/integration-overview), [SDK Quickstart](/cow-sdk/quickstart), and [Widget guide](/cow-protocol/howto/integrate/widget).
      </Step>
...
| **Developer** integrating CoW | [Integration overview](/cow-protocol/explanation/integration-overview) or [SDK Quickstart](/cow-sdk/quickstart) |
