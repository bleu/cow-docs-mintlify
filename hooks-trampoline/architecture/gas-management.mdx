...
- [Security Model](/hooks-trampoline/architecture/security) — Understanding access control and privilege isolation
- [Settlement Flow](/hooks-trampoline/architecture/settlement-flow) — How hooks integrate into the complete settlement lifecycle
