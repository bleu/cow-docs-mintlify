...
- [Gas Management](/hooks-trampoline/architecture/gas-management) — How gas limits protect against resource exhaustion
- [Settlement Flow](/hooks-trampoline/architecture/settlement-flow) — Understanding the complete settlement lifecycle
