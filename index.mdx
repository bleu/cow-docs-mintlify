    ...
    <Steps>
      ...
      <Step title="Follow a working tutorial">
        ...
        <Accordion title="Suggested starting tutorials">
          ...
          - **Solver operators**: [Test locally](/cow-protocol/tutorials/solvers/local_test) → [Onboard](/cow-protocol/howto/solvers/onboard)
...
| **Solver operator** running a solver | [Test locally](/cow-protocol/tutorials/solvers/local_test) then [onboard](/cow-protocol/howto/solvers/onboard) |
