    ...
    <Steps>
      ...
      <Step title="Follow a working tutorial">
        ...
        <Accordion title="Suggested starting tutorials">
          - **Traders**: [Place a swap](/cow-swap/tutorials/swap) → [Set a limit order](/cow-swap/tutorials/limit) → [Create a TWAP](/cow-swap/tutorials/twap)
          - **Developers**: [SDK Quickstart](/cow-sdk/quickstart) → [Create a swap order](/cow-sdk/guides/creating-swap-orders) → [Widget integration](/cow-swap/widget/overview)
...
|---|---|
| **Trader** wanting to swap tokens | [What is CoW Protocol?](/cow-protocol/overview) then [place a swap](/cow-swap/tutorials/swap) |
