...
description: "How the CoW Protocol Watch Tower persists state using LevelDB, including key layout, durability guarantees, and operational considerations."
---

# Storage Architecture

The Watch Tower uses a key-value database to maintain state about programmatic orders and block processing progress.
...
* Store programmatic orders by owner
...
<Warning>
The watch-tower may reprocess blocks after a crash. Your programmatic order handlers should be idempotent to handle duplicate submissions gracefully.
</Warning>
