...
description: "Watch-tower codebase structure, execution flow, and key modules"
---
...
- **Event handling**: `src/domain/events/`
  ...
  - Indexes new programmatic orders in registry
  - Processes events atomically per block

### 5. Order Polling

- **Polling logic**: `src/domain/polling/`
  - Checks each registered programmatic order
