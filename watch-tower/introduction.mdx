...
* [Build a custom conditional order handler](/composable-cow/advanced/custom-orders) — the Watch Tower will automatically discover and poll any handler deployed via ComposableCoW
